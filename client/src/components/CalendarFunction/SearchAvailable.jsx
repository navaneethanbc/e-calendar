...
const SearchAvailable = ({ searchQuery, setSearchQuery, startDate, setStartDate, endDate, setEndDate, category, setCategory, notifications,showSearch,setShowSearch }) => {
  ...
  return (
    <div className="flex justify-end items-center w-full p-4">
        {showSearch && (
        <div> 
            <form className="flex space-x-4 items-end ml-auto" onSubmit={(e)=>{e.preventDefault()}}>
            <TextField
                value={searchQuery}
                type="text"
